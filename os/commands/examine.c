/* examine.c - view and change memory a byte at a time: examine addr
     examine 5000   shows  5000: vv  and reads keys (conin, no echo; what is typed is echoed by examine):
   ...
   Ported from P8X os/commands/examine.c 2026-09-23, changes: the keys come from conin() without echo, so examine
