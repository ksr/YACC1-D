...
- [`cards/memory/kicad/v2.0`](cards/memory/kicad/v2.0/) — see its README (the built memory v1.3 + the CF interface on P8/P9; schematic proven; whole card being RE-LAID (Ken 2026-09-24): three placement options, each trial-routed complete, option B recommended, waiting for Ken's pick; not ordered)
