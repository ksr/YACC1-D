...
| `cards/memory/eagle/v1.3/Memory V1.3` | [`memory-v1.3`](cards/memory/kicad/v1.3/) | yes | MATCH (115/115 nets) | 103 | 250 + 100 unconnected | 95 | 0 | ok |
...
- [`cards/io/kicad/v2.0`](cards/io/kicad/v2.0/) — see its README (I/O card v1.1 + the CF interface on P4/P5; placement options, not routed)
