...
| memory | v1.3 | `cards/memory/eagle/v1.3` | `cards/memory/eagle/v1.3/fab/` jlcpcb-order-2000765A-Y42.zip | Ken 2026-09-24 | THE BUILT CARD: Fusion 360 export (2026-09-24) of the design JLCPCB made on 2025-06-27 (order 2000765A, 4 layers; order archive in fab/). tools/verify_fab_vs_brd.py: all 695 holes and all 1,263 top/bottom tracks are in the order's gerbers, part list and pick-and-place match. Differs from the earlier save (eagle/deprecated/v1.3-do-not-use) by IC15 74ALS11 (74245 enable = AND of the card's chip selects instead of -VMA) and the routed TMP registers IC26-IC29 + RN5/RN6. Filed as eagle/v1.3-fusion-export-2026-09-24 and renamed to eagle/v1.3 the same day (Ken). KiCad conversion in cards/memory/kicad/v1.3 |
...
| Revision | Status | Design | Files sent to fab | Note |
|---|---|---|---|---|
| v1.3 | in-machine (Ken 2026-09-24) | `cards/memory/eagle/v1.3` | `cards/memory/eagle/v1.3/fab/` jlcpcb-order-2000765A-Y42.zip | THE BUILT CARD: Fusion 360 export (2026-09-24) of the design JLCPCB made on 2025-06-27 (order 2000765A, 4 layers; order archive in fab/). tools/verify_fab_vs_brd.py: all 695 holes and all 1,263 top/bottom tracks are in the order's gerbers, part list and pick-and-place match. Differs from the earlier save (eagle/deprecated/v1.3-do-not-use) by IC15 74ALS11 (74245 enable = AND of the card's chip selects instead of -VMA) and the routed TMP registers IC26-IC29 + RN5/RN6. Filed as eagle/v1.3-fusion-export-2026-09-24 and renamed to eagle/v1.3 the same day (Ken). KiCad conversion in cards/memory/kicad/v1.3 |
...
| v1.3 | design-only | `cards/memory/eagle/deprecated/v1.3-do-not-use` | - | DO NOT USE - EARLIER SAVE (Notes 2025-03-06, board 2021-03-17) of the v1.3 design, NOT the built card (found 2026-09-24; was eagle/v1.3 until Ken renamed and deprecated it 2026-09-24): no IC15, IC5 pin 19 on -VMA, TMP registers IC26-IC29 and RN5/RN6 placed off the board, unrouted. Kept for its history (Notes.md/.rtf, ROM ZSelect.circ). fab/Memory V1_2025-06-27.zip is the built card's gerber set (= the order's; its design is eagle/v1.3); fab/CAMOutputs/ are older 2020 CAM runs. The Working folder also held V1.0 files (= revision 1.1) and an earlier save of V1.2 - removed 2026-09-20 |
