...
- `eagle/v1.3-fusion-export-2026-09-24/` – **the card in the machine**: Ken's Fusion 360 export (2026-09-24) of the design
  ...
  **IC15 74ALS11**: the 74245 data buffer (IC5) is enabled by AND(-LO-RAM, -HI-RAM, -ROM-CS), i.e. only while one of
  ...
  $D000). The TMP registers IC26–IC29 and RN5/RN6 are placed and routed. KiCad conversion (proven):
  `../kicad/v1.3-fusion-export-2026-09-24/`.
- `eagle/v1.3/` – **earlier save (notes 2025-03-06, board 2021-03-17), NOT the built card** (found 2026-09-24): no IC15
