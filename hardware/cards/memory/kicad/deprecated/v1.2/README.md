...
Generated 2026-09-20 by `tools/eagle_to_kicad_all.py` from the Eagle design `Memory V1.2` in `hardware/cards/memory/eagle/deprecated/v1.2/`. **The Eagle files are the record of what was designed and built; this KiCad project is derived from them and is regenerated from scratch on every run of the tool** (hand edits here will be lost - once a card is edited in KiCad, remove it from the tool's list). This revision was FABRICATED (see `hardware/FABRICATED.md`).
...
ERC by type: endpoint_off_grid 34, isolated_pin_label 43, pin_not_connected 1.
...
Converter: converted: 228 symbols, 609 wires, 339 labels, 122 junctions, 11 bus lines, 9 no-connects
