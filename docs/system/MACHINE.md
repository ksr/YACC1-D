...
| Memory | v1.3 (boards ordered 2025-06-27, JLCPCB 2000765A) | `hardware/cards/memory/eagle/v1.3-fusion-export-2026-09-24` (+ KiCad) | see jumpers below. The built design is the Fusion export of 2026-09-24 (proven against the order's gerbers); `eagle/v1.3` is an earlier save without IC15 (the 74245 enable) and with the TMP registers off the board |
