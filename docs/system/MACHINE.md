...
Ken's confirmations of 2026-09-19/20. Ken answered the open questions on 2026-09-20; the one **(confirm)** mark left is the sequencer-card ATmega firmware (the bus tester's was settled 2026-09-21 by reading its flash out).
