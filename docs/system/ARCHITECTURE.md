...
| P8 | planned: CompactFlash register-select latch (ATA register 0–7 in bits 0–2) |
| P9 | planned: CompactFlash data (the ROM driver, `O` command and both emulators already use P8/P9; the card is not built) |
