...
| `sequencer-card/` | Sequencer-Memory card ATmega328 | `sequencer4` (2026-09-21: 400 kHz I2C, block EEPROM reads, verified copy) = the firmware in the card; `deprecated/sequencer3` (2021-08-25 + IO.ino 2024-07-10) = what it ran before; `microcode-loader/simple_microcode_sender_64` (Processing, 115200, reads `firmware/microcode/.../test.hexz`, keeps `cache`); `dumpram`; `test-eeprom` | `sequencer1` (2020-08), `sequencer2` (2020-12), senders 1 and 2 (19200, v1 generator), the Sept-2020 EEPROM test |
