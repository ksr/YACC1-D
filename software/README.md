...
| `disassembler/disasm2/` | microcode disassembler for the 64-step Generator2 format | does not build as committed (signal-table include commented out); see its README |
