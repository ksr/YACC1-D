...
for root, dirs, files in os.walk(DST):
    ...
    for f in files:
        ...
        elif rel.startswith(("hardware/cards/video/kicad/v1.1/", "hardware/cards/memory/kicad/v2.0/")): buckets["mine: KiCad design masters (MASTER marker)"] += 1
