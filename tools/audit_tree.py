...
HAND_MADE = ("firmware/rom/eprom-captured-", "tests/video/", "tests/memory/")   # session artefacts / bench tests written in YACC1-D, not from YACCS      # session artefacts that are not from YACCS
