...
HAND_MADE = ("firmware/rom/eprom-captured-", "tests/video/", "tests/memory/", "hardware/cards/video/docs/", "embedded/bus-tester/readback/", "embedded/sequencer-card/readback/", "tests/sequencer/", "tests/assembler/ledcount/", "docs/system/waveforms/", "embedded/sequencer-card/sequencer4/", "hardware/DESIGN-REVIEW")   # session artefacts / bench tests written in YACC1-D, not from YACCS      # session artefacts that are not from YACCS
